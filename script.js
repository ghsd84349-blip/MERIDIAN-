...
const PROPERTIES = [
  // ---- MOSCOW ----
  { id: 1, city: 'moscow', type: 'buy', title: 'Апартаменты на Тверской', price: 184000000, currency: '₽', area: 142, areaUnit: 'м²', floor: 14, totalFloors: 18, rooms: 4 },
  { id: 2, city: 'moscow', type: 'rent', title: 'Penthouse Patriarshie', price: 980000, currency: '₽', area: 168, areaUnit: 'м²', floor: 17, totalFloors: 17, rooms: 5 },
  { id: 3, city: 'moscow', type: 'buy', title: 'Резиденция Остоженка', price: 96500000, currency: '₽', area: 98, areaUnit: 'м²', floor: 6, totalFloors: 12, rooms: 3 },
  { id: 4, city: 'moscow', type: 'rent', title: 'Лофт на Красном Октябре', price: 420000, currency: '₽', area: 86, areaUnit: 'м²', floor: 3, totalFloors: 6, rooms: 2 },
  { id: 5, city: 'moscow', type: 'buy', title: 'Дом у Москва-Сити', price: 210000000, currency: '₽', area: 175, areaUnit: 'м²', floor: 41, totalFloors: 52, rooms: 4 },
  { id: 6, city: 'moscow', type: 'rent', title: 'Апартаменты Никитская', price: 510000, currency: '₽', area: 104, areaUnit: 'м²', floor: 9, totalFloors: 14, rooms: 3 },

  // ---- SPB ----
  { id: 7, city: 'spb', type: 'buy', title: 'Резиденция на Мойке', price: 78000000, currency: '₽', area: 112, areaUnit: 'м²', floor: 3, totalFloors: 5, rooms: 3 },
  { id: 8, city: 'spb', type: 'rent', title: 'Апартаменты Васильевский', price: 290000, currency: '₽', area: 74, areaUnit: 'м²', floor: 4, totalFloors: 6, rooms: 2 },
  { id: 9, city: 'spb', type: 'buy', title: 'Пентхаус на Крюковом канале', price: 132000000, currency: '₽', area: 156, areaUnit: 'м²', floor: 6, totalFloors: 6, rooms: 4 },
  { id: 10, city: 'spb', type: 'rent', title: 'Дом у Новой Голландии', price: 340000, currency: '₽', area: 90, areaUnit: 'м²', floor: 2, totalFloors: 4, rooms: 3 },
  { id: 11, city: 'spb', type: 'buy', title: 'Резиденция Петровский остров', price: 64000000, currency: '₽', area: 88, areaUnit: 'м²', floor: 8, totalFloors: 11, rooms: 2 },

  // ---- NY ----
  { id: 12, city: 'ny', type: 'buy', title: 'Penthouse Liberty', price: 6800000, currency: '$', area: 2150, areaUnit: 'sq ft', floor: 42, totalFloors: 44, rooms: 4 },
  { id: 13, city: 'ny', type: 'rent', title: 'Tribeca Loft Residence', price: 18500, currency: '$', area: 1680, areaUnit: 'sq ft', floor: 6, totalFloors: 8, rooms: 3 },
  { id: 14, city: 'ny', type: 'buy', title: 'Park Avenue Residence', price: 9200000, currency: '$', area: 2400, areaUnit: 'sq ft', floor: 18, totalFloors: 20, rooms: 5 },
  { id: 15, city: 'ny', type: 'rent', title: 'Hudson Yards Sky Suite', price: 22000, currency: '$', area: 1950, areaUnit: 'sq ft', floor: 51, totalFloors: 55, rooms: 3 },
  { id: 16, city: 'ny', type: 'buy', title: 'SoHo Cast-Iron Penthouse', price: 5400000, currency: '$', area: 1820, areaUnit: 'sq ft', floor: 5, totalFloors: 5, rooms: 3 },
];
